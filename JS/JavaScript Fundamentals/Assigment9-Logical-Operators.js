// 1. Comment out the previous code so the prompt doesn't get in
// the way.
...
//  that accounts for all of Sarah's criteria. Take your time with
//  this, and check part of the solution if necessary.

// 4, If yours is the right country, log a strings like this
// 'You should live in Portugal :)'. If not, log 'Portugal
// does not meet your criteria :('.

// 5. Probably your country does not meet all the criteria.
//  So go back and temporarily change some variables in order to
